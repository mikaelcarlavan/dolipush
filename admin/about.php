...
/**
 *  \file       htdocs/dolipush/index.php
 *  \ingroup    dolipush
...
$versions = array(
	array('version' => '1.0.0', 'date' => '10/10/2022', 'updates' => $langs->trans('DoliPushFirstVersion')),
);
/*
 * View
 */
...
llxHeader('', $langs->trans('DoliPushAbout'));

// Subheader
$linkback = '<a href="' . DOL_URL_ROOT . '/admin/modules.php">'. $langs->trans("BackToModuleList") . '</a>';
print load_fiche_titre($langs->trans('DoliPushAbout'), $linkback);
...
echo $langs->trans("DoliPushAboutPage");

echo '<br />';

print '<h2>'.$langs->trans("About").'</h2>';
print $langs->trans("DoliPushAboutDescLong");
